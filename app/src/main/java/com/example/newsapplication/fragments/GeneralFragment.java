...
public class GeneralFragment extends Fragment  implements  MainArticleAdapter.OnItemclickListner {
    ...
    private void loadNewsdata() {
        ...
        Call<ResponseModel> call = apiService.getLatestNews(general, API_KEY);
